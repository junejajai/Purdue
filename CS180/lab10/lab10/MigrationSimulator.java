...
public class MigrationSimulator {
    ...
    public int[] getBirdBearCount(Site site) throws IllegalAnimalException {
        ...
        // int totalSize = birds.length + bears.length;
        int combiArray[] = new int[2];
        int countBird = 0;
        int countBear = 0;
        ...
        for (Animal animal : site.getAnimals()) {
            {
                ...
                if(animal instanceof Bird && animal.getStatus().equals("ALIVE"))
                countBird++;
                
                if(animal instanceof Bear && animal.getStatus().equals("ALIVE"))
                countBear++;
                
            }
        }

        combiArray[0] = countBird; 
        combiArray[1] = countBear;            
        //   return null;
        return combiArray; 
